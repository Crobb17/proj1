...
massCalc_2 = massformula(round(periodic_table.AtomicWeight (atomicNumber_2)), atomicNumber_2);
atomInfor = Ptable (atomicNumber_2, :);
...
elseif nargin == 2
    ...
    elseif (class(input_1) == 'double' & (class(input_2) == 'string')
        ...
        if sum (contains(columnNames, input_2)) == 1
            columnTitle = find(contains(column_names, input_2) ==1
